...
const jsonRoutes = ["/api/dashboard/summary", "/api/signal-lane", "/api/window-map", "/api/board-pressure", "/api/priority-bands", "/api/risk-map", "/api/verification", "/api/sample", "/api/payload"];
